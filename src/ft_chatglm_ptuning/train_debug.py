...
def main():
    ...
    model_args = ModelArguments(
        model_name_or_path='/Users/jishoukai/.cache/huggingface/hub/models--gpt2/snapshots/607a30d783dfa663caf39e06633721c8d4cfcd7e',
        config_name=None, tokenizer_name=None, cache_dir=None, use_fast_tokenizer=True, model_revision='main', use_auth_token=False,
        resize_position_embeddings=None, quantization_bit=None, pre_seq_len=128, prefix_projection=False)
    data_args = DataTrainingArguments(lang=None, dataset_name=None, dataset_config_name=None, prompt_column='input', response_column='target',
                                      history_column=None, train_file='/Users/jishoukai/PycharmProjects/PromptCBLUEOLD/datasets/PromptCBLUE/toy_examples/train.json',
                                      validation_file='/Users/jishoukai/PycharmProjects/PromptCBLUEOLD/datasets/PromptCBLUE/toy_examples/dev.json', test_file=None, overwrite_cache=True,
                                      preprocessing_num_workers=None, max_source_length=700, max_target_length=196, val_max_target_length=196,
                                      pad_to_max_length=False, max_train_samples=None, max_eval_samples=None, max_predict_samples=None, num_beams=None,
                                      ignore_pad_token_for_loss=True, source_prefix='', forced_bos_token=None)
    training_args = Seq2SeqTrainingArguments(output_dir=os.path.join("/root/autodl-fs/data2/root/.cache/modelscope/hub/models--THUDM--visualglm-6b/", f"PromptCBLUE-chatglm-6b-pt-128-2e-2"),
